...
plob_sound = pygame.mixer.Sound("binglyd.ogg")
score_sound = pygame.mixer.Sound("Pointlyd.ogg")
...
ball = Ball('Bold.png',screen_width/2,screen_height/2,4,4,paddle_group)
